...
data_path = "C:/Users/xande/PycharmProjects/MusicGenerator/Midi Data"
...
def batch_producer(raw_data, batch_size, num_steps):
    ...
    i = tf.data.Dataset.range(epoch_size).repeat(60)
...
if args.run_opt == 1:
    train(train_data, vocabulary, num_layers=2, num_epochs=60, batch_size=20,
          model_save_name='two-layer-lstm-medium-config-60-epoch-0p93-lr-decay-10-max-lr-final')
else:
